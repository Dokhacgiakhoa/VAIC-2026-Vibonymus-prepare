  ...
  return (
    <div className="page-content">
      ...
      <div className="card">
        ...
        <p className="sub" style={{ margin: '0 0 16px' }}>Các mốc giải thưởng hiện kim và cơ hội công nghệ cực kỳ hấp dẫn mà cả team đang nhắm tới.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
          <div style={{ padding: '20px', background: 'var(--surface-page)', borderRadius: '16px', border: '1px solid var(--border)' }}>
            <h3 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.98rem', fontWeight: 700, margin: '0 0 12px 0', color: 'var(--s3)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
              Giải thưởng chính (Hiện kim)
            </h3>
            <ul className="checklist" style={{ paddingLeft: '15px' }}>
          ...
          <div style={{ padding: '20px', background: 'var(--surface-page)', borderRadius: '16px', border: '1px solid var(--border)' }}>
            <h3 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.98rem', fontWeight: 700, margin: '0 0 12px 0', color: 'var(--s1)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
      ...
      <div className="card">
        ...
        <p className="sub" style={{ margin: '0 0 16px' }}>Dữ liệu điểm số và năng lực của các đội thi dẫn đầu được trích xuất trực tiếp từ bảng điểm Excel.</p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center', padding: '16px 20px', background: 'var(--surface-page)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #ffd700, #ffa500)', color: '#fff', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif' }}>1</div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center', padding: '16px 20px', background: 'var(--surface-page)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #c0c0c0, #939393)', color: '#fff', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif' }}>2</div>
            <div style={{ flex: 1, minWidth: '180px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center', padding: '16px 20px', background: 'var(--surface-page)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #cd7f32, #8c4b18)', color: '#fff', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif' }}>3</div>
            <div style={{ flex: 1, minWidth: '180px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center', padding: '16px 20px', background: 'var(--surface-page)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--grid)', color: 'var(--text-secondary)', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif' }}>4</div>
            <div style={{ flex: 1, minWidth: '180px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center', padding: '16px 20px', background: 'var(--surface-page)', borderRadius: '14px', border: '1px solid var(--border)' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--grid)', color: 'var(--text-secondary)', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif' }}>5</div>
            <div style={{ flex: 1, minWidth: '180px' }}>
      ...
      {/* Target Note */}
      <div className="card" style={{ display: 'flex', gap: '16px', alignItems: 'flex-start', background: 'rgba(32, 201, 151, 0.06)', borderColor: 'rgba(32, 201, 151, 0.2)' }}>
        <Flame style={{ color: 'var(--good)', flexShrink: 0, marginTop: '2px' }} size={24} />
        <div>
