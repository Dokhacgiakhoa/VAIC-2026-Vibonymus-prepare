export const trackData = [
  {
    ...
    aiPoints: [
      { point: 'OCR & Cấu trúc hóa', desc: 'Sử dụng Gemini Pro Vision để nhận diện chữ viết tay của bác sĩ và cấu trúc hóa dữ liệu.' },
      { point: 'Medical RAG (Truy xuất y khoa)', desc: 'Tích hợp cơ sở dữ liệu Vector DB chứa sách giáo khoa y học và phác đồ điều trị để chống hallucination (ảo tưởng).' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Market Analysis Agent', desc: 'Sử dụng LLM phân tích xu hướng tìm kiếm và gợi ý ngách sản phẩm ít cạnh tranh.' },
      { point: 'PRD & Code Generator', desc: 'Tự động soạn tài liệu đặc tả và sinh boilerplate code giao diện landing page.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Intent Routing Agent', desc: 'Sử dụng Claude để phân loại ý định khách hàng với độ chính xác cao và định tuyến luồng xử lý phù hợp.' },
      { point: 'RAG on Product Catalog', desc: 'Truy xuất thông tin sản phẩm và chính sách hoàn trả thời gian thực từ cơ sở dữ liệu tri thức của công ty.' },
      { point: 'Function Calling (Gọi hàm)', desc: 'AI tự quyết định khi nào cần gọi API cập nhật kho hàng hoặc sinh mã giảm giá giữ chân khách hàng.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'OCR Extract & Autofill', desc: 'Sử dụng thị giác máy tính trích xuất thông tin giấy tờ tùy thân điền tự động vào biểu mẫu hành chính phức tạp.' },
      { point: 'Administrative RAG', desc: 'Đối chiếu các điều khoản pháp luật, thông tư hướng dẫn hành chính công thực tế để tư vấn chính xác.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Disease Classification', desc: 'Mô hình CNN nhận diện bệnh hại cây trồng qua ảnh chụp thời gian thực.' },
      { point: 'Irrigation Decision Agent', desc: 'Agent phân tích độ ẩm đất, nhiệt độ và dự báo mưa để tự động ra quyết định đóng/mở van tưới.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Knowledge Gap Analyzer', desc: 'Thuật toán AI phân tích logic lỗi sai của học sinh để định vị chính xác phần kiến thức bị hổng.' },
      { point: 'Dynamic Question Generator', desc: 'Tự động tạo ra các bài tập có độ khó tăng dần (Adaptive Learning) phù hợp với tiến trình học tập.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Geospatial Deep Learning', desc: 'Mô hình học máy phân tích ảnh vệ tinh và bản đồ độ cao số để dự báo sạt lở đất.' },
      { point: 'Route Optimization AI', desc: 'Thuật toán tìm đường tránh chướng ngại vật ngập lụt động thời gian thực.' }
    ],
  ...
  },
  {
    ...
    aiPoints: [
      { point: 'Transaction Categorization', desc: 'Phân loại các chuỗi text giao dịch ngân hàng viết tắt không chuẩn hóa thành nhóm chi tiêu cụ thể.' },
      { point: 'Financial Advisor Agent', desc: 'Soạn thảo lời khuyên tài chính cá nhân dựa trên phân tích dòng tiền thực tế của người dùng.' }
    ],
