...
const scoringCriteria = [
  {
    ...
    detail: (
      <>
        <p style={{ margin: '0 0 8px' }}>AI phải xử lý logic nghiệp vụ lõi (ví dụ: LangGraph routing, SQL auto-query) chứ không chỉ làm chatbot rỗng. Code sạch, có cấu trúc tốt, có <b>AI Collaboration Log</b> đầy đủ.</p>
  ...
  },
  {
    ...
    detail: (
      <>
        <p style={{ margin: '0 0 8px' }}><b>Xác nhận chính thức (slide Evaluation Framework):</b> phân biệt <b>AI-Native (Transformational)</b> — toàn bộ value proposition dựa trên AI reasoning, có vòng lặp dữ liệu phản hồi độc quyền — với <b>AI Feature (Incremental)</b> — chỉ nhúng AI như tính năng phụ trợ (VD: autocomplete).</p>
  ...
  },
  {
    ...
    detail: (
      <>
        <p style={{ margin: '0 0 8px' }}><b>Framework "Enterprise Pilot Dynamics":</b> trả lời 3 câu hỏi cốt lõi — <i>What problem are you solving? Can you solve it? Will anyone pay for it?</i></p>
        <p style={{ margin: '0 0 8px' }}>Phân biệt <b>Users</b> (người dùng trực tiếp, gánh vận hành) vs <b>Customers</b> (người trả tiền — quan tâm price-sensitivity, risk mitigation, time-to-value, bottom-line). Xác định 3 ROI metrics: Efficiency, Accuracy/Quality, Scale.</p>
  ...
  },
  {
    ...
    detail: (
      <>
        <p style={{ margin: '0 0 8px' }}>Giải pháp RAG phải có cơ chế chống hallucination (Grounding) — trả lời có nguồn tham chiếu thật.</p>
  ...
  },
  {
    ...
    detail: (
      <>
        <p style={{ margin: '0 0 8px' }}>K.AI pitching tự tin, giải thích thuyết phục tính tự vệ công nghệ (Defensibility) trước ban giám khảo.</p>
...
const Dashboard = () => {
  ...
  return (
    <div className="page-content">
        ...
        <div>
          <h1 style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span className="icon-badge">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: '22px', height: '22px', color: '#fff' }}>
      ...
      <div className="card">
        ...
        <div className="gantt-scroll">
          <div className="gantt">
              ...
              <div className="gantt-track" style={{ '--cols': 9 }}>
                <div className="bar-wrapper" style={{ left: '33.3%', width: '22.2%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}>
                      <span className="legend-dot" style={{ background: 'var(--s4)', width: '8px', height: '8px', borderRadius: '50%' }}></span>
                      <span style={{ fontWeight: 700, textTransform: 'uppercase', fontSize: '0.7rem', color: 'var(--text-muted)' }}>BTC · Sự kiện</span>
                    </div>
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Partner Sessions</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11-12/07</div>
                ...
                <div className="bar-wrapper" style={{ left: '44.4%', width: '11.1%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Workshop 5 — Pitching</div>
                ...
                <div className="bar-wrapper" style={{ left: '66.7%', width: '11.1%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Preparation Day</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 14/07</div>
              ...
              <div className="gantt-track" style={{ '--cols': 9 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '33.3%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Research &amp; Set up</div>
                ...
                <div className="bar-wrapper" style={{ left: '33.3%', width: '22.2%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Partner Sessions &amp; Kiến trúc mẫu</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11-12/07</div>
                ...
                <div className="bar-wrapper" style={{ left: '55.6%', width: '22.2%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Boilerplate Code &amp; Test AI Tool</div>
                ...
                <div className="bar-wrapper" style={{ left: '77.8%', width: '11.1%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Quét &amp; đánh giá đối thủ (kỹ thuật)</div>
              ...
              <div className="gantt-track" style={{ '--cols': 9 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '33.3%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Research &amp; Áp dụng 3 câu hỏi</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 08-10/07</div>
                ...
                <div className="bar-wrapper" style={{ left: '33.3%', width: '22.2%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Partner Session &amp; Khung phân tích</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11-12/07</div>
                ...
                <div className="bar-wrapper" style={{ left: '55.6%', width: '22.2%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Tổng hợp phân tích track ứng viên</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 13-14/07</div>
                ...
                <div className="bar-wrapper" style={{ left: '77.8%', width: '11.1%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Quét &amp; đánh giá đối thủ (business)</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 15/07</div>
            ...
            <div className="gantt-phase-label" style={{ marginTop: '26px' }}>Ngày 1 — Thứ Sáu 17/07 (08:00–24:00)</div>
              ...
              <div className="gantt-track" style={{ '--cols': 16 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '9.38%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Check-in</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 08:00-09:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '9.38%', width: '3.13%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Khai mạc</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 09:30-10:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '18.75%', width: '3.13%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Công bố Track</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '25%', width: '3.13%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Genius Station chính thức mở cửa</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 12:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '50%', width: '9.38%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Workshop nhà tài trợ</div>
                ...
                <div className="bar-wrapper" style={{ left: '71.88%', width: '9.38%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Giao lưu AI &amp; DJ</div>
                ...
                <div className="bar-wrapper" style={{ left: '81.25%', width: '18.75%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Dev xuyên đêm + Night Owl Stream</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 21:00-05:00</div>
              ...
              <div className="gantt-track" style={{ '--cols': 16 }}>
                <div className="bar-wrapper" style={{ left: '18.75%', width: '18.75%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Phân tích đề &amp; Chọn stack</div>
                ...
                <div className="bar-wrapper" style={{ left: '37.5%', width: '25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Dựng kiến trúc &amp; Skeleton repo</div>
                ...
                <div className="bar-wrapper" style={{ left: '81.25%', width: '18.75%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Code core feature</div>
              ...
              <div className="gantt-track" style={{ '--cols': 16 }}>
                <div className="bar-wrapper" style={{ left: '18.75%', width: '18.75%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Xác định user &amp; Bài toán</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11:00-14:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '37.5%', width: '25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Viết user flow &amp; Data schema</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 14:00-18:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '81.25%', width: '18.75%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Hỗ trợ test &amp; Bắt đầu AI log</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 21:00-24:00</div>
            ...
            <div className="gantt-phase-label" style={{ marginTop: '26px' }}>Ngày 2 — Thứ Bảy 18/07 (00:00–24:00)</div>
              ...
              <div className="gantt-track" style={{ '--cols': 24 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '29.17%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Dev xuyên đêm (tiếp)</div>
                ...
                <div className="bar-wrapper" style={{ left: '37.5%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Mentor Wave 1 (kỹ thuật)</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 09:00-10:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '66.67%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Mentor Wave 2 (UX/business)</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 16:00-17:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '75%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Ăn tối &amp; hoạt động faction</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 18:00-19:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '87.5%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Checkpoint 2</div>
                ...
                <div className="bar-wrapper" style={{ left: '95.83%', width: '4.17%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Dev đêm cuối</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 23:00-07:00</div>
              ...
              <div className="gantt-track" style={{ '--cols': 24 }}>
                ...
                <div className="bar-wrapper past" style={{ left: '16.67%', width: '12.5%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Nghỉ ngắn</div>
                ...
                <div className="bar-wrapper" style={{ left: '29.17%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Ăn sáng &amp; Review kiến trúc</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 07:00-09:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '37.5%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Trình bày kiến trúc với Mentor 1</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 09:00-10:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '50%', width: '16.67%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Build tính năng lõi + Tích hợp AI</div>
                ...
                <div className="bar-wrapper past" style={{ left: '75%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Ăn tối &amp; Nghỉ ngắn</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 18:00-19:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '87.5%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Chuẩn bị deploy Checkpoint 2</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 21:00-23:00</div>
              ...
              <div className="gantt-track" style={{ '--cols': 24 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '16.67%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Test luồng + Viết AI log</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 00:00-04:00</div>
                ...
                <div className="bar-wrapper past" style={{ left: '16.67%', width: '12.5%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Nghỉ ngơi</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 04:00-07:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '37.5%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Ghi chú góp ý Mentor 1</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 09:00-10:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '41.67%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Checkpoint 1 — Chủ trì nộp bài</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 10:00-12:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '50%', width: '16.67%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Hoàn thiện data flow &amp; Project description</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 12:00-16:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '66.67%', width: '6.25%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Mentor Wave 2 — Trình bày</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 16:00-17:30</div>
                ...
                <div className="bar-wrapper" style={{ left: '87.5%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Checkpoint 2 — Tổng hợp link nộp</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 21:00-23:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '95.83%', width: '4.17%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Viết AI collaboration log</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 23:00-24:00</div>
            ...
            <div className="gantt-phase-label" style={{ marginTop: '26px' }}>Ngày 3 — Chủ Nhật 19/07 (00:00–17:00)</div>
              ...
              <div className="gantt-track" style={{ '--cols': 18 }}>
                ...
                <div className="bar-wrapper" style={{ left: '38.89%', width: '11.11%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Ăn sáng &amp; Hoàn thiện nộp bài</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 07:00-09:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '61.11%', width: '5.56%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}>
                      <span className="legend-dot" style={{ background: 'var(--critical)', width: '8px', height: '8px', borderRadius: '50%' }}></span>
                      <span style={{ fontWeight: 700, textTransform: 'uppercase', fontSize: '0.7rem', color: 'var(--text-muted)' }}>BTC · Sự kiện</span>
                    </div>
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Hạn chót nộp bài</div>
                    <div style={{ color: 'var(--critical)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '72.22%', width: '5.56%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Mở cửa khu vực cộng đồng</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 13:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '83.33%', width: '2.78%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Công bố Top 10</div>
                ...
                <div className="bar-wrapper" style={{ left: '86.11%', width: '8.33%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Pitch trực tiếp</div>
                ...
                <div className="bar-wrapper" style={{ left: '94.44%', width: '5.56%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Lễ trao giải</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 17:00</div>
              ...
              <div className="gantt-track" style={{ '--cols': 18 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '38.89%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Sửa lỗi &amp; Ổn định demo</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 00:00-07:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '38.89%', width: '11.11%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Hỗ trợ đóng gói nộp bài</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 07:00-09:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '50%', width: '11.11%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Kiểm thử lần cuối</div>
              ...
              <div className="gantt-track" style={{ '--cols': 18 }}>
                <div className="bar-wrapper" style={{ left: '0%', width: '38.89%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Hoàn thiện AI log &amp; Mô tả dự án</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 00:00-07:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '38.89%', width: '11.11%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Tổng hợp 5 hạng mục nộp bài</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 07:00-09:00</div>
                ...
                <div className="bar-wrapper" style={{ left: '50%', width: '11.11%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Nộp bài chính thức</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 09:00-11:00</div>
                ...
                <div className="bar-wrapper past" style={{ left: '61.11%', width: '16.67%' }}>
                  ...
                  <div className="gantt-tooltip-css">
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.9rem', marginBottom: '4px', color: 'var(--text-primary)' }}>Theo dõi, chờ kết quả</div>
                    <div style={{ color: 'var(--s1)', fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem' }}>Khung giờ: 11:00-14:00</div>
      ...
      <div className="card">
        <h2>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '22px', height: '22px', color: 'var(--s1)' }}>
            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
          </svg>
          Tiêu chí chấm điểm &amp; Rào cản điểm số (Scoring Barriers)
        </h2>
        <p className="sub" style={{ margin: '0 0 16px' }}>Định hướng phát triển sản phẩm bám sát 6 tiêu chí đánh giá cốt lõi của Ban giám khảo VAIC 2026 (tổng điểm 100). Bấm vào từng dòng để xem chi tiết:</p>
          ...
          <table className="cross-table" style={{ minWidth: 0 }}>
            <thead>
              <tr>
                ...
                <th style={{ textAlign: 'right', width: '100px' }}>Trọng số điểm</th>
              </tr>
            </thead>
            <tbody>
